...
try{
	...
	$iduser="";
	try{
		if(!isset($_GET["Id_Utente"])) 		throw new Exception("No parameter get");
		...
		echo $finale;
	}catch(Exception $eccezione1){
		//eccezione errore url, o errore parametro get
		header( "refresh:0; url=../PHP/Errori.php?errore=utenti" ); 
	}

}catch(Exception $eccezione2){
