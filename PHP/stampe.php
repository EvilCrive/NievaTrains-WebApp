...
function stampaEditbio(){
	return '<form action="../PHP/userManage.php" id="editbioform" method="post"><fieldset><textarea rows="5" cols="300" name="bio"></textarea><button class="button">Modifica BIO</button></fieldset></form>';
}
