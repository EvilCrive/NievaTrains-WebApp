...
<body>
	<!--header-->
		...
		<!--breadcrumb-->
			<div id="breadcrumb">
				<ul>
					<li>Ti trovi in: <span xml:lang="en" lang="en"><a href="./home.html">Home</a></span> -&gt; Secondi -&gt; Pesce</li>
	...
	<div id="content">
		...
		<h3>Ricette Simili:</h3>
			<?php 
			$result=$connessione->getQuery("SELECT Descrizione_Immagine, Nome_Immagine, Nome FROM ricetta WHERE Categoria='Pesce';");
