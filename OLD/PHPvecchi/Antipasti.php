...
<body>
	<!--header-->
		...
		<!--breadcrumb-->
			<div id="breadcrumb">
				<ul>
					<li>Ti trovi in: <span xml:lang="en" lang="en"><a href="./home.html">Home</a></span> -&gt; Antipasti</li>
  ...
  <div id="content">
	...
	<!--PHP start-->
		...
		<h3>Ricette:</h3>
			<?php 
			$result=$connessione->getQuery("SELECT Descrizione_Immagine, Nome_Immagine, Nome FROM ricetta WHERE Macro_Categoria='Antipasti';");
